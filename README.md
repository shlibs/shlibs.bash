...
To make Android Application Kits on smartphone, tablet and TV, copy and paste the following into [Termux](https://github.com/termux) in order to install [shlibs.bash](https://github.com/shlibs/shlibs.bash) in its proper place:
...
Also to make Android Application Kits on smartphone, tablet and TV, copy and paste the following into Termux in order to install [shlibs.bash](https://github.com/shlibs/shlibs.bash) in its proper place:
