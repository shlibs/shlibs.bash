...
_PRINTUMODS_() {
	printf "\\e[1;2;38;5;190m%s%s\\e[0m\\n\\n" "Updating buildAPKs: '${0##*/} mod.bash' is loading sources from submodule repositorie $JID into buildAPKs.  This may take a little while to complete.  Please be patient if this script wants to download source code from https://github.com:"
}
