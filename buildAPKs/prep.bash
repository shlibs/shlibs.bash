...
FLIST=("*-debug.key" "*.apk"  "*.aar" ".classpath" "*.jar" ".gitignore" ".project" ".settings" "Android.kpf" "ant.properties" "app.iml" "build.gradle" "build.properties" "build.xml" ".classpath" "default.properties" "gen" "gradle-wrapper.jar" "gradle-wrapper.properties" "gradlew" "gradlew.bat" "gradle.properties" "gradle.xml" "lint.xml" "local.properties" "makefile" "makefile.linux_pc" "out" "org.eclipse.jdt.core.prefs" "pom.xml" "proguard.cfg" "proguard-project.txt" "proguard-rules.pro" "project.properties" "R.java" "settings.gradle" "WebRTCSample.iml")
# prep.bash EOF
