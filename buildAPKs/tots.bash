...
rm -rf "$TMPDIR/fa$$"
printf '\n%s\n' "You can share information about new projects at https://github.com/BuildAPKs/db.BuildAPKs/issues and https://github.com/BuildAPKs/db.BuildAPKs/pulls to help develop this project."
# tots.bash EOF
