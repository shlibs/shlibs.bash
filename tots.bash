...
find "$JDR" -type f -name AndroidManifest.xml 2>"$RDR/log/stnderr.tots.bash.$NUM.log" > "$TMPDIR/fa$$/possible" ||: 
find "$JDR" -type f -name "*.apk" 2>"$RDR/log/stnderr.tots.bash.$NUM.log" > "$TMPDIR/fa$$/built" ||: 
cd "$TMPDIR/fa$$"
